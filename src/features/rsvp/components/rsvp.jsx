  ...
  return (
    <section id="rsvp" className={cn("relative overflow-hidden bg-[#f5f0eb]")}>
      ...
      <img
        ...
        alt=""
        className={cn("pointer-events-none absolute -left-24 top-14 w-52 -rotate-12 opacity-25")}
      />
        ...
        >
          <label className={cn("grid gap-2 text-sm font-medium uppercase tracking-[0.16em] text-[#262626]")}>
            ...
            <div className={cn("relative")}>
              <Search className={cn("absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-[#ff4582]")} />
              <input
                value={name}
                onChange={(event) => setName(event.target.value)}
                className={cn("super-transition w-full rounded-full border border-[#262626]/10 bg-white py-4 pl-11 pr-4 text-base normal-case tracking-normal outline-none focus:border-[#ff4582]")}
          ...
          {isFetching && (
            <p className={cn("flex items-center gap-2 text-sm font-medium text-[#262626]/50")}>
          ...
          {match && (
            <div className={cn("flex items-center justify-between rounded-2xl bg-[#f5f0eb] p-4 text-left")}>
              <div>
                <p className={cn("super-label text-[#262626]/45")}>Encontramos</p>
                <p className={cn("mt-1 text-xl font-semibold text-[#262626]")}>{match.full_name}</p>
              </div>
              <span className={cn("rounded-full bg-[#ff4582] px-3 py-1 text-sm font-semibold text-[#262626]")}>
                {confidence}
              </span>
            </div>
          )}
          ...
          <label className={cn("grid gap-2 text-sm font-medium uppercase tracking-[0.16em] text-[#262626]")}>
            ...
            <input
              ...
              className={cn("super-transition w-full rounded-full border border-[#262626]/10 bg-white px-4 py-4 text-base normal-case tracking-normal outline-none focus:border-[#ff4582]")}
            />
          </label>
          ...
          <label className={cn("grid gap-2 text-sm font-medium uppercase tracking-[0.16em] text-[#262626]")}>
            ...
            <textarea
              ...
              rows={3}
              className={cn("super-transition w-full rounded-3xl border border-[#262626]/10 bg-white px-4 py-4 text-base normal-case tracking-normal outline-none focus:border-[#ff4582]")}
              placeholder="Deixe um recado para os noivos"
            />
          </label>

          {mutation.error && (
            <div className={cn("rounded-2xl bg-white p-4 text-sm font-medium text-[#262626]")}>
          ...
          {mutation.isSuccess && (
            <div className={cn("rounded-2xl bg-[#ff4582] p-4 text-sm font-semibold text-[#262626]")}>
